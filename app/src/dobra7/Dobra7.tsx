...
function Dobra7() {
  ...
  return(
    <div id="quem-somos" className="my-9 desktop:my-[10%]">
      ...
      <iframe className="w-[327px] h-[174px] mx-auto tablet:mt-9 tablet:w-[700px] tablet:h-[300px]" data-src="https://www.youtube.com/embed/6Q9mLiNtzTA" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen loading="lazy"></iframe>
    </div>
  )
}
