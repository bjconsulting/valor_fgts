  ...
  return (
    <div className="tablet:flex tablet:flex-row tablet:max-w-[834px] tablet:mx-auto tablet:items-start desktop:max-w-[1440px]">
      <div className="tablet:w-[770px]">
        ...
        <div className="font-[nexa] font-bold text-sm text-center w-[297px] mx-auto my-2 tablet:font-normal tablet:text-left tablet:text-base tablet:font-bold tablet:w-[402px] tablet:mt-5 desktop:text-[22px] desktop:leading-[31.24px] desktop:w-[580px]">Adiante até 10 parcelas do seu Saque Aniversário. Clique em fale conosco, nos chame no Whatsapp, e receba seu adiantamento hoje mesmo.</div>
