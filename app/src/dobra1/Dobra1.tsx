  ...
  return (
    <div className="tablet:flex tablet:flex-row tablet:max-w-[834px] tablet:mx-auto tablet:items-start desktop:max-w-[1440px]">
      <div className="tablet:w-[770px]">
        ...
        <a href={WhatsAppCtaUrl()} target="_blank" rel="noreferrer" className="bg-[#158B7D] text-white rounded-xl px-4 py-2 flex justify-evenly w-44 items-center mx-auto mt-5 tablet:ml-16 desktop:ml-24 desktop:w-64 desktop:py-5"><p className="text-xl desktop:text-[32px]">Fale conosco</p><RiWhatsappLine className="w-5 h-5" /></a>
      </div>
