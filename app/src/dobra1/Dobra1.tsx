  ...
  return (
    <div className="tablet:flex tablet:flex-row tablet:max-w-[834px] tablet:mx-auto tablet:items-start desktop:max-w-[1440px]">
      <div className="tablet:w-[770px]">
        ...
        <h2 className="text-[5.8vw] text-center font-bold my-1 tablet:text-[40px] tablet:leading-[48px] desktop:text-[70px] desktop:leading-[84px]">Antecipe até <span className="text-[#D5B473]">10 Anos</span> do seu FGTS</h2>
        ...
        <a href={WhatsAppCtaUrl()} target="_blank" rel="noreferrer" className="bg-[#158B7D] text-white rounded-xl px-4 py-2 flex justify-evenly w-44 items-center mx-auto mt-5 tablet:ml-16 desktop:ml-24 desktop:w-64 desktop:py-5"><p className="text-xl desktop:text-[32px]">Fale conosco</p><img className="w-5 h-5" src={wp} alt="Logo do WhatsApp"/></a>
      </div>
      <img className="mx-auto w-full my-10 tablet:w-[294px] tablet:my-0 desktop:w-[542px]" src={photo_banner} alt="Pessoa feliz ao telefone com a mensagem 'simples, rápido e seguro'"/>
    </div>
  );
}
