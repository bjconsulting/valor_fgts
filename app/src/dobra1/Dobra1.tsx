  ...
  return (
    <div className=" flex flex-col gap-8 tablet:flex tablet:flex-row tablet:max-w-[834px] tablet:mx-auto tablet:items-start desktop:max-w-[1440px]">
      <div className="tablet:w-[770px] flex flex-col gap-8">
        ...
        <h1 className="text-[32px] leading-[30px] text-center font-bold my-1 tablet:text-[40px] tablet:leading-[48px] desktop:text-[70px] desktop:leading-[84px]">Antecipe até <span className="text-[#D5B473]">10 Anos</span> do seu FGTS</h1>
