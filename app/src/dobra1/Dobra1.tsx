...
function Dobra1() {
  return (
    <div className=" flex flex-col gap-8 tablet:flex tablet:flex-row tablet:max-w-[834px] tablet:mx-auto tablet:items-start desktop:max-w-[1440px]">
      <div className="tablet:w-[770px] flex flex-col gap-4 tablet:gap-8">
        ...
        <h1 className="text-[32px] leading-[35px] text-center font-bold my-1 tablet:text-[40px] tablet:leading-[48px] desktop:text-[70px] desktop:leading-[84px]">Antecipe até <span className="text-[#A59145]">10 Anos</span> do seu FGTS</h1>
        <div className="font-[nexa] font-bold text-sm text-center w-[297px] mx-auto my-2 tablet:text-base tablet:font-bold tablet:w-[402px] tablet:mt-5 desktop:text-[22px] desktop:leading-[31.24px] desktop:w-[580px]">Adiante até 10 parcelas do seu Saque Aniversário. Clique em fale conosco, nos chame no Whatsapp, e receba seu adiantamento hoje mesmo.</div>
        <WhatsAppCta buttonClassName="bg-[#106b62] text-white rounded-xl px-4 py-2 flex justify-evenly w-44 items-center mx-auto tablet:mt-5 desktop:w-64 desktop:py-5" textClassName="text-xl desktop:text-[32px]" />
      </div>
