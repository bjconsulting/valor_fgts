  ...
  return(
    <div className="w-full bg-[#3C4450] pt-10 text-white text-center pb-10 tablet:pt-20 tablet:flex tablet:flex-row tablet:flex-grow tablet:justify-evenly tablet:text-left">
      <div className='tablet:flex tablet:flex-col'>
        ...
        <div className='w-[243px] mx-auto my-10 text-xs tablet:w-auto'>
          VALOR SERVIÇOS FINANCEIROS LTDA<br/>CNPJ: 42.095.396/0001-48<br/>TELEFONE: (18) 3600-7910<br/><br/>
          <a href="https://fgts.valorservicos.com.br/termos-de-uso" target="_blank" rel='noreferrer' className='text-[10px] hover:underline transition-all hover:text-sub w-max'>Política de Privacidade</a>
        </div>
      </div>
      <div className='tablet:flex tablet:flex-col'>
