...
function Dobra4() {
  return(
    <div className='max-w-[393px] mx-auto tablet:max-w-[834px]'>
      ...
      <div className="flex flex-wrap justify-center gap-y-12 gap-x-5 my-12">
