  ...
  return(
    <div className='max-w-[393px] mx-auto tablet:max-w-[834px] desktop:max-w-[1300px]'>
      <div className='tablet:flex tablet:flex-row tablet:justify-center tablet:items-center tablet:gap-10 desktop:gap-[80px] desktop:justify-start desktop:items-start'>
        <div className="hidden advbg w-[156px] h-[141px] bg-[-110px_-110px] tablet:flex flex-col pt-0 items-center text-center tablet:w-[213.49px] tablet:h-[191.8px] tablet:bg-[length:245px] desktop:aspect-[1.1] desktop:h-auto desktop:w-[400px] desktop:bg-cover desktop:mt-10 justify-center desktop:tablet-7">
      ...
      <div className='flex flex-wrap justify-center gap-y-5 gap-x-5 mb-10 tablet:gap-x-10 desktop:gap-x-[50px]'>
        <div className="advbg w-[156px] h-[141px] bg-[-110px_-110px] flex flex-col pt-0 items-center text-center tablet:hidden tablet:w-[213.49px] tablet:h-[191.8px] tablet:bg-[length:245px] desktop:aspect-[1.1] desktop:h-auto desktop:w-[290px] desktop:bg-cover tablet:pt-14 justify-center">
        ...
        <div className="advbg w-[156px] h-[141px] bg-[-110px_-110px] flex flex-col pt-0 items-center text-center tablet:w-[213.49px] tablet:h-[191.8px] tablet:bg-[length:245px] desktop:aspect-[1.1] desktop:h-auto desktop:w-[400px] desktop:bg-cover justify-center tablet:pt-14">
        ...
        <div className="advbg w-[156px] h-[141px] bg-[-110px_-110px] flex flex-col pt-0 items-center text-center tablet:w-[213.49px] tablet:h-[191.8px] tablet:bg-[length:245px] desktop:aspect-[1.1] desktop:h-auto desktop:w-[400px] desktop:bg-cover justify-center tablet:pt-14">
          ...
          <p className="font-[nexa] text-sm font-bold tablet:text-base tablet:w-[169px] tablet:mx-auto desktop:text-2xl desktop:w-[90%]">Taxa min. 1,79%<br/>&nbsp;</p>
        </div>
        <div className="advbg w-[156px] h-[141px] bg-[-110px_-110px] flex flex-col pt-0 items-center text-center tablet:w-[213.49px] tablet:h-[191.8px] tablet:bg-[length:245px] desktop:aspect-[1.1] desktop:h-auto desktop:w-[400px] desktop:bg-cover justify-center tablet:pt-14">
