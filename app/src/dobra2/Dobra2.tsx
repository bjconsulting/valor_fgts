...
function Dobra2() {
  return (
    <div className='flex flex-row overflow-hidden tablet:max-w-[834px] tablet:mx-auto tablet:mt-10 desktop:max-w-[1440px] desktop:mt-20 desktop:justify-evenly'>
      ...
      <div className='tablet:w-[545px] tablet:block desktop:w-[600px]'>
        <h2 className="text-lg text-center font-bold my-1 tablet:text-3xl desktop:text-[44px] desktop:leading-[66px]">O que é o <span className="text-[#D5B473]">Empréstimo FGTS?</span></h2>
        <div className='mx-auto max-w-[393px] tablet:max-w-[456px] desktop:max-w-[574px]'>
          <div className="pl-11 mt-5 text-xs flex items-start gap-3 tablet:items-center tablet:pl-4 desktop:mt-14">
