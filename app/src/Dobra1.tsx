...
function Dobra1() {
  return (
    <>
      <h1 className='text-[10px] text-center font-bold'>Antecipação do saque aniversário do FGTS</h1>
      ...
      <button className="bg-[#158B7D] text-white rounded-xl px-4 py-2 flex justify-evenly w-44 items-center mx-auto my-5"><p className="text-xl">Fale conosco</p><img className="w-5 h-5" src={wp}/></button>
      <img className="mx-auto w-60" src={photo_banner}/>
    </>
  );
}
